# [EDIT] 2024-01-15 Raphael Beck, Glitched Polygons GmbH

> As per the Apache-2.0 license, the following are my changes applied to this font directory:
> - Updated this `README.md`
> - Added `RobotoMono-Bold.woff`
> - Added `RobotoMono-Bold.woff2`
> - Added `RobotoMono-Bold.eot`
> - Added `RobotoMono-Bold.svg`
> - - I used https://transfonter.org to generate these additional font files based off of the Google Font's provided `.ttf` files.
> (For better cross-browser compat.)
